import type { Cursor } from "jsr:/@cliffy/ansi@1.0.0-rc.5/cursor-position";
import { type Tty, tty } from "jsr:/@cliffy/ansi@1.0.0-rc.5/tty";
import { type KeyCode, parse } from "jsr:@cliffy/keycode@1.0.0-rc.5";
import {
  bold,
  brightBlue,
  dim,
  ...
  stripAnsiCode,
  yellow,
} from "jsr:/@std/fmt@~0.225.4/colors";
import type { Reader, WriterSync } from "jsr:/@std/io@~0.224.2/types";
...
import { exit } from "jsr:/@cliffy/internal@1.0.0-rc.5/runtime/exit";
import { getColumns } from "jsr:/@cliffy/internal@1.0.0-rc.5/runtime/get-columns";
import { isTerminal } from "jsr:/@cliffy/internal@1.0.0-rc.5/runtime/is-terminal";
import { read } from "jsr:/@cliffy/internal@1.0.0-rc.5/runtime/read";
